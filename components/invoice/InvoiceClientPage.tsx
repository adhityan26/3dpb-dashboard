            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  <span className="text-sm font-bold g-t1">{inv.nomor}</span>
                  <span
              ...
              {/* Date */}
              <div className="text-xs flex-shrink-0 text-right g-t4">
              ...
              <div className="text-right flex-shrink-0 min-w-[100px]">
                <div className="text-sm font-bold g-t1">{fmt(inv.total)}</div>
                {inv.totalPaid > 0 && inv.sisaBayar > 0 && (
                  <div className="text-[10px] mt-0.5" style={{ color: "rgba(251,191,36,0.7)" }}>
                    Bayar: {fmt(inv.totalPaid)} · Sisa: {fmt(inv.sisaBayar)}
                  </div>
                )}
                {inv.totalPaid > 0 && inv.sisaBayar === 0 && (
                  <div className="text-[10px] mt-0.5" style={{ color: "rgba(52,211,153,0.7)" }}>
                    Lunas
                  </div>
                )}
              </div>
