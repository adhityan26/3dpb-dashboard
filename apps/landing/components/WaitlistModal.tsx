...
export function WaitlistModal({ interest, onClose }: { interest: "beli" | "subscribe"; onClose: () => void }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: "rgba(0,0,0,0.8)", backdropFilter: "blur(4px)", WebkitBackdropFilter: "blur(4px)" }} onClick={onClose}>
      <div className="wl-modal rounded-[16px] p-5 w-full max-w-sm" onClick={e => e.stopPropagation()}>
