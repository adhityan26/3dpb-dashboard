...
export default async function AdminPage() {
  ...
  return (
    <PageShell title="Admin Slizebiz" description="Kelola konfigurasi, waitlist, pembayaran, dan user." current="admin" owner={true} userLabel={session?.user?.email ?? undefined}>
      <AdminTabs tabs={tabs} />
    </PageShell>
  );
}
